  ...
  <div>
    <div id="map">
      <div>
        ...
        />
        <button type="button" class="btn btn-primary" @click="map.removeObjects(map.getObjects()), createFarmBoundaryPolygon(map), addMarkersfromVueXStore(map, checkedcategories)">Seleted</button>
        <button type="button" class="btn btn-danger" @click="map.removeObjects(map.getObjects()), createFarmBoundaryPolygon(map)">Clear</button>
        <button type="button" class="btn btn-primary" @click=" map.removeObjects(map.getObjects()), createFarmBoundaryPolygon(map), addMarkersfromVueXStore(map, animalcategories)">All</button>
      </div>
